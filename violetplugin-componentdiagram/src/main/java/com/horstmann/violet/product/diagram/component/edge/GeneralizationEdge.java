...
package com.horstmann.violet.product.diagram.component.edge;
 ...
 */
public class GeneralizationEdge extends LabeledLineEdge
{
    ...
    protected GeneralizationEdge(GeneralizationEdge clone)
    {
        super(clone);
    }

    @Override
    public GeneralizationEdge copy()
    {
    ...
    {
        return ComponentDiagramConstant.COMPONENT_DIAGRAM_RESOURCE.getString("tooltip.generalization");
    }
}
